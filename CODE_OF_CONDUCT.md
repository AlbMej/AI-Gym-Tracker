# AI-powered Sport Analytics(AIPSA) Code of Conduct
In the interest of fostering an open and welcoming environment, AIPSA pledges to be an inclusive and harassment-free experience for all, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, educational background, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.

This Code of Conduct applies to all AIPSA-affiliated activity online and offline.
...
* [Focus on what is best for the [AIPSA] community](#focus-on-what-is-best-for-the-community).
...
* Summarize any [project-specific guidelines](#AIPSA-specific-guidelines) (if any) here.
...
## AIPSA-Specific Guidelines
Any additional ground rules for the AIPSA team to follow will be added here. 

Ground rules regarding technical or project management aspects of AIPSA will go in the Contributing Guidelines.
